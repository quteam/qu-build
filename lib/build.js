...
exports.getWebpackConfig = exports.webpack = undefined;
...
function getWebpackConfig() {
  ...
  entryArr.map(function (pathname) {
    ...
    webpackConfig.plugins.push(new _htmlWebpackPlugin2.default(conf));
  });
  if (entryArr.length > 1) {
...
function build(args, callback) {
  ...
  webpackConfig.forEach(function (config) {
    ...
    if (args.dev) {
      ...
      _rimraf2.default.sync(fileOutputPath);

      var _publicPath = (0, _path.resolve)(args.cwd, './public');
      if ((0, _fs.existsSync)(_publicPath)) {
        config.plugins.push(new _copyWebpackPlugin2.default([{
          from: _publicPath,
          ignore: ['.*']
        }], {
          copyUnmodified: true
      ...
      if (args.pwa) {
        config.plugins.push(new _swPrecacheWebpackPlugin2.default({
